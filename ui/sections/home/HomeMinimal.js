...
const CARDS = [
  {
    icon: '/static/home/ic_design.svg',
    title: 'UI & UX Design',
    description:
      'The set is built on the principles of the atomic design system. It helps you to create projects fastest and easily customized packages for your projects.'
  },
  {
    icon: '/static/home/ic_code.svg',
    title: 'Development',
  ...
  },
  {
    ...
    description: 'It provides GraphQL for REST API, Subscription for real time changes'
  }
];
      ...
      <Container>
        ...
        >
          {CARDS.map((card, index) => (
            <CardStyle key={index} className={(index === 0 && 'cardLeft') || (index === 1 && 'cardCenter') || ''}>
              <Image
                src={card.icon}
                alt={card.title}
                sx={{
